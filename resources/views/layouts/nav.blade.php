<div cl<div class="navbar bg-green-800 text-white shadow-lg">
    {{-- logo --}}
    <div class="mx-2">
    ...
    <div class="flex-1 md:hidden">
      <div class="dropdown">
        ...
        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
          <li><a href="{{ route('inmuebles.index') }}">nuevos proyectos</a></li>
          <li> <a href="">Servicios</a> </li>           
          <li><a href="{{ route('inmuebles.index') }}">Productos</a></li>
          <li><a href="{{ route('inicio') }}">Acerca de nosotros</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="flex-1 hidden md:flex space-x-4">
      <a href="{{ route('inmuebles.index') }}" class="btn btn-ghost btn-sm">Mi proyecto</a>
      <div class="dropdown ">
